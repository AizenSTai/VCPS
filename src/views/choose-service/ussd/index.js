...
import ForthPage from 'src/views/choose-service/ussd/ForthPage'
...
const Ussd = (prop) => {
  ...
  const ClickEv = (event) => {
    // localStorage.setItem("ussdlist", event)
    prop.onSetvalue('ussd', event)
        ...
        <Card sx={{ zIndex: 1 }}>
          <CardContent sx={{ padding: theme => `${theme.spacing(12, 9, 7)} !important` }}>
            ...
            <Box>
              <Card >
                <Grid sm={12}>
                  <ForthPage onBack={prop.onBack} onClick={ClickEv} />
                </Grid>
              </Card>
            </Box>
          </CardContent>
