...
const NajaButton = props => {

  const { title, ShowOnClick, najaDisplayables, NajaType, countType, onClick, subtitle, icon, src, height, width } = props
  let num = 1
    ...
    <Card sx={{
      ...
      <Box sx={{ display: "flex", flexDirection: "column", width: "100%", height: "100%" }}>
        ...
        <Box sx={{ marginTop: "auto" }}>
          ...
          {ShowOnClick && <Button fullWidth size='large' onClick={() => { onClick != null && onClick(src), (najaDisplayables != null && NajaType != null) && najaDisplayables(NajaType) }} variant='contained' sx={{ borderRadius: "30px", width: "auto", m: 5, mb: 2, mt: "0", fontSize: "0.7rem" }} >
            {subtitle}
          </Button>}
        </Box>
      </Box>
...
export default NajaButton

NajaButton.defaultProps = {
  color: 'primary',
  trend: 'positive'
}
