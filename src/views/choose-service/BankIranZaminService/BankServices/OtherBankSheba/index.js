...
const OtherBankSheba = (prop) => {

    const [pass, setPass] = useState("9gshj-gfh-wej-lkjl")
    const [sheba, setSheba] = useState("IR190090000657290000000000")
    const data = JSON.stringify({ clientAddress: "127.0.0.0", acceptorCode: pass, iban: sheba })
    ...
    return (
        <Box sx={{ width: "75%", margin: "0 auto" }}>
            <Card sx={{ backgroundColor: "#FAFAFA" }}>
                ...
                <Box sx={{ display: "flex" }}>
                    <Typography sx={{ margin: "0 auto", border: "1px solid #ddd", borderRadius: "15px", fontSize: "1.1rem", p: 10, pt: 5, pb: 5 }}>استعلام شماره شبای سایر بانکها</Typography>
                </Box>
