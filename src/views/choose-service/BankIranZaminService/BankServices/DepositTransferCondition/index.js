...
const DepositTransferCondition = (prop) => {
    ...
    const BankNationalcodeHandler = async () => {
        if (true) {
            ...
            const Auth = await fetch(`https://sbxapi.izbank.ir/private/general-services/v1/getDepositTransferCondition`, {
                method: 'POST',
                body: data,
                headers: {
    ...
    return (
        <Box sx={{ width: "75%", margin: "0 auto" }}>
            <Card sx={{ backgroundColor: "#FAFAFA" }}>
                ...
                <Box sx={{ display: "flex" }}>
                    <Typography sx={{ margin: "0 auto", border: "1px solid #ddd", borderRadius: "15px", fontSize: "1.1rem", p: 10, pt: 5, pb: 5 }}>دریافت پیام شرایط انتقال وجه</Typography>
                </Box>
...
export default DepositTransferCondition