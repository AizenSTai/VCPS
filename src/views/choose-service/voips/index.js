...
import SecondPage from 'src/views/choose-service/voips/SecondPage'
...
const Voips = (prop) => {
  ...
  const ClickEv = (event) => {
    // localStorage.setItem("voiplist", event)
    prop.onSetvalue('voip', event)
  ...
  return (
    <Box style={{ display: 'block', margin: "0 auto", width: "500px", justifyContent: 'center', alignItems: 'center', marginTop: 100 + 'px', zIndex: "1" }}>
      <Box>
        <Card sx={{ zIndex: 1 }}>
          <CardContent sx={{ padding: theme => `${theme.spacing(12, 9, 7)} !important` }}>
            ...
            <Box>
              <Card >
                <Grid sm={12}>
                  <SecondPage onBack={prop.onBack} onClick={ClickEv} />
                </Grid>
              </Card>
            </Box>
            <Box sx={{ mt: 6 }}>
